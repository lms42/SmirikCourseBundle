...
/**
 * This class defines the structure of the 'lessons_content_urls' table.
 *
 *
 *
 ...
 */
class UrlContentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Smirik.CourseBundle.Model.map.UrlContentTableMap';
    ...
    {
        // attributes
        $this->setName('lessons_content_urls');
        $this->setPhpName('UrlContent');
        $this->setClassname('Smirik\\CourseBundle\\Model\\UrlContent');
