...
/**
 * This class defines the structure of the 'lessons_content_youtube' table.
 *
 *
 *
 ...
 */
class YoutubeContentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Smirik.CourseBundle.Model.map.YoutubeContentTableMap';
    ...
    {
        // attributes
        $this->setName('lessons_content_youtube');
        $this->setPhpName('YoutubeContent');
        $this->setClassname('Smirik\\CourseBundle\\Model\\YoutubeContent');
