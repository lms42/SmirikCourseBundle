...
/**
 * This class defines the structure of the 'lessons_content_slideshare' table.
 *
 *
 *
 ...
 */
class SlideshareContentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Smirik.CourseBundle.Model.map.SlideshareContentTableMap';
    ...
    {
        // attributes
        $this->setName('lessons_content_slideshare');
        $this->setPhpName('SlideshareContent');
        $this->setClassname('Smirik\\CourseBundle\\Model\\SlideshareContent');
