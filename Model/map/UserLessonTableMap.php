...
/**
 * This class defines the structure of the 'users_lessons' table.
 *
 *
 *
 ...
 */
class UserLessonTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Smirik.CourseBundle.Model.map.UserLessonTableMap';
    ...
    {
        // attributes
        $this->setName('users_lessons');
        $this->setPhpName('UserLesson');
        $this->setClassname('Smirik\\CourseBundle\\Model\\UserLesson');
