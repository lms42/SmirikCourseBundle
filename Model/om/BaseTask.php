...
abstract class BaseTask extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Smirik\\CourseBundle\\Model\\TaskPeer';
    ...
    public function setLessonId($v)
    {
        ...
        if ($this->lesson_id !== $v) {
            $this->lesson_id = $v;
            $this->modifiedColumns[] = TaskPeer::LESSON_ID;
        }
    ...
    public function setText($v)
    {
        ...
        if ($this->text !== $v) {
            $this->text = $v;
            $this->modifiedColumns[] = TaskPeer::TEXT;
        }
    ...
    public function setFile($v)
    {
        ...
        if ($this->file !== $v) {
            $this->file = $v;
            $this->modifiedColumns[] = TaskPeer::FILE;
        }
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            TaskPeer::shiftRank(-1, $this->getSortableRank() + 1, null, $this->getLessonId(), $con);
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(TaskPeer::RANK_COL)) {
                    $this->setSortableRank(TaskQuery::create()->getMaxRank($this->getLessonId(), $con) + 1);
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TaskPeer::LESSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`LESSON_ID`';
        }
        if ($this->isColumnModified(TaskPeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`TITLE`';
        }
        if ($this->isColumnModified(TaskPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`TEXT`';
        }
        if ($this->isColumnModified(TaskPeer::FILE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaskPeer::LESSON_ID)) $criteria->add(TaskPeer::LESSON_ID, $this->lesson_id);
        if ($this->isColumnModified(TaskPeer::TITLE)) $criteria->add(TaskPeer::TITLE, $this->title);
        if ($this->isColumnModified(TaskPeer::TEXT)) $criteria->add(TaskPeer::TEXT, $this->text);
        if ($this->isColumnModified(TaskPeer::FILE)) $criteria->add(TaskPeer::FILE, $this->file);
     ...
     * @return PropelObjectCollection|UserTask[] List of UserTask objects
     */
    public function getUserTasksJoinLesson($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UserTaskQuery::create(null, $criteria);
    ...
    {
        return $this->getSortableRank() == TaskQuery::create()->getMaxRank($this->getLessonId(), $con);
    }
    ...
    public function getNext(PropelPDO $con = null)
    {
        ...
        return TaskQuery::create()->findOneByRank($this->getSortableRank() + 1, $this->getLessonId(), $con);
    }
    ...
    public function insertAtRank($rank, PropelPDO $con = null)
    {
        ...
        $maxRank = TaskQuery::create()->getMaxRank($this->getLessonId(), $con);
    ...
    public function moveToRank($newRank, PropelPDO $con = null)
    {
        ...
        if ($newRank < 1 || $newRank > TaskQuery::create()->getMaxRank($this->getLessonId(), $con)) {
        ...
        try {
            ...
            TaskPeer::shiftRank($delta, min($oldRank, $newRank), max($oldRank, $newRank), $this->getLessonId(), $con);
    ...
    public function moveToBottom(PropelPDO $con = null)
    {
        ...
        $con->beginTransaction();
        try {
            $bottom = TaskQuery::create()->getMaxRank($this->getLessonId(), $con);
