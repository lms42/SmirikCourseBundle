...
abstract class BaseUserCourse extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Smirik\\CourseBundle\\Model\\UserCoursePeer';
    ...
    /**
     * Initializes internal state of BaseUserCourse object.
     * @see        applyDefaults()
     */
     ...
     * @return UserCourse The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = UserCoursePeer::ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserCoursePeer::USER_ID;
        }
    ...
    public function setCourseId($v)
    {
        ...
        if ($this->course_id !== $v) {
            $this->course_id = $v;
            $this->modifiedColumns[] = UserCoursePeer::COURSE_ID;
        }
    ...
    public function setStartedAt($v)
    {
        ...
        if ($this->started_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UserCoursePeer::STARTED_AT;
            }
    ...
    public function setStoppedAt($v)
    {
        ...
        if ($this->stopped_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UserCoursePeer::STOPPED_AT;
            }
        } // if either are not null
    ...
    public function setIsPassed($v)
    {
        ...
        if ($this->is_passed !== $v) {
            $this->is_passed = $v;
            $this->modifiedColumns[] = UserCoursePeer::IS_PASSED;
        }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UserCoursePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->stopped_at = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->is_passed = ($row[$startcol + 5] !== null) ? (boolean) $row[$startcol + 5] : null;
            ...
            return $startcol + 7; // 7 = UserCoursePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UserCourse object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserCoursePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserCourseQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(UserCoursePeer::STARTED_AT)) {
                    $this->setStartedAt(time());
                }
                if (!$this->isColumnModified(UserCoursePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(UserCoursePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                UserCoursePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserCoursePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(UserCoursePeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(UserCoursePeer::COURSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`COURSE_ID`';
        }
        if ($this->isColumnModified(UserCoursePeer::STARTED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`STARTED_AT`';
        }
        if ($this->isColumnModified(UserCoursePeer::STOPPED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`STOPPED_AT`';
        }
        if ($this->isColumnModified(UserCoursePeer::IS_PASSED)) {
        ...
        $sql = sprintf(
            'INSERT INTO `users_courses` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UserCoursePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UserCoursePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UserCourse'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserCourse'][$this->getPrimaryKey()] = true;
        $keys = UserCoursePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUserId(),
            $keys[2] => $this->getCourseId(),
            $keys[3] => $this->getStartedAt(),
            $keys[4] => $this->getStoppedAt(),
            $keys[5] => $this->getIsPassed(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setStoppedAt($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setIsPassed($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserCoursePeer::ID)) $criteria->add(UserCoursePeer::ID, $this->id);
        if ($this->isColumnModified(UserCoursePeer::USER_ID)) $criteria->add(UserCoursePeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(UserCoursePeer::COURSE_ID)) $criteria->add(UserCoursePeer::COURSE_ID, $this->course_id);
        if ($this->isColumnModified(UserCoursePeer::STARTED_AT)) $criteria->add(UserCoursePeer::STARTED_AT, $this->started_at);
        if ($this->isColumnModified(UserCoursePeer::STOPPED_AT)) $criteria->add(UserCoursePeer::STOPPED_AT, $this->stopped_at);
        if ($this->isColumnModified(UserCoursePeer::IS_PASSED)) $criteria->add(UserCoursePeer::IS_PASSED, $this->is_passed);
        if ($this->isColumnModified(UserCoursePeer::UPDATED_AT)) $criteria->add(UserCoursePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(UserCoursePeer::DATABASE_NAME);
        $criteria->add(UserCoursePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of UserCourse (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UserCourse Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UserCoursePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UserCoursePeer();
        }
    ...
    public function getUser(PropelPDO $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addUserCourses($this);
             */
        }
    ...
    public function getCourse(PropelPDO $con = null)
    {
        if ($this->aCourse === null && ($this->course_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCourse->addUserCourses($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UserCoursePeer::DEFAULT_STRING_FORMAT);
    }
